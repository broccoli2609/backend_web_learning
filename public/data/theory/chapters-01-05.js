...
<p><strong>Idempotent</strong> — gọi lại nhiều lần cho cùng kết quả. <code>GET</code>, <code>HEAD</code>, <code>OPTIONS</code>, <code>PUT</code>, <code>DELETE</code> nên idempotent; <code>POST</code> thì không. Điều này quan trọng vì mạng không đáng tin: client mất kết nối giữa chừng sẽ gọi lại, và nếu <code>POST /orders</code> không được bảo vệ thì server sẽ tạo thêm một đơn hàng nữa, khiến khách hàng chỉ mua một lần nhưng lại có hai đơn hàng trong hệ thống.</p>
